	...
	public void nextMove()
	{
		...
		if(optionSelect(key)<=0)
		{
			...
			if(optionSelect(key)<=0)
			{
				...
				int i=score(),j=totalCount()-score(),a;
				String s;
				...
				else
				{
					s="white";
					a=j;
					temp =new ImageIcon("brown.jpg");
					//l1.setIcon(image1);
					/*f1.add(l1);
					f1.pack();
					f1.setVisible(true);*/
				}
				JOptionPane.showMessageDialog(null,s + "  is the winner "+"who is having the score of  "+a+" points......",s, JOptionPane.INFORMATION_MESSAGE,temp);
				//JOptionPane.showMessageDialog(null,s + "  is the winner "+"who is having the score of  "+a+" points......");
				return;
			}
